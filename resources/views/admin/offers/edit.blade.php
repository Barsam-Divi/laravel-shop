                ...
                <form action="{{route('offers.update',$offer)}}" method="post">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">تغییر کد نخفیف</h3>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="code" id="inputName" class="form-control" value='{{$offer->code}}'>
                            </div>
                            <div class="form-group">
                                <label for="started">شروع</label> <br>
                                <input type="date" name="started_at" id="started" value="{{$offer->started_at->format('Y-m-d')}}"><br>
                            </div>
                            <div class="form-group">
                                <label for="expires">پایان</label> <br>
                                <input type="date" name="expires_at" id="expires" value="{{$offer->expires_at->format('Y-m-d')}}"><br>
                            </div>
                        </div>
